...
from prompts import system_prompt_judge,system_prompt_rag,system_prompt_roteador,fewshots_roteador,system_prompt_eta_gerente,fewshots_eta_gerente
...
from pgtoolsteste import TOOLS
